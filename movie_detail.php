            ...
            <div class="movie-detail-wrapper">
                ...
                <div class="movie-detail-content">
                    ...
                    <div class="movie-detail-info">
                        ...
                        <div class="movie-detail-info-item">
                            <span class="main-color">Genre:</span> <?php foreach($genres_movie as $genre_movie) { echo $genre_movie['genre_name'] . " "; } ?>
                        </div>
                        <div class="movie-detail-info-item">
                            <span class="main-color">Director:</span> <?php echo $director[0]['director_name']; ?>
                        </div>
                        <div class="movie-detail-info-item">
                            <span class="main-color">Stars:</span> <?php foreach($actors as $actor) { echo $actor['name'] . " "; } ?>
                        </div>
                    </div>
