...
<body>
    <?php 
        ...
        $sqlmovies = "SELECT * FROM movie";
        $movies = $pdo->query($sqlmovies)->fetchAll(PDO::FETCH_ASSOC);
        ...
        $movies_phantrang = $pdo->query($sql)->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <?php
                    foreach($movies_phantrang as $movie) {
                ?>
                    <!-- MOVIE ITEM -->
        ...
        <div class="p-3 text-center">
            <a>
                <?php echo $pager->pageList($_GET['page'], $pages, $param = NULL); ?>
            </a>
        </div>
    </div>
